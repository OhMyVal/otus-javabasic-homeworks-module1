...
//               h.leaveTransport(t); // если это убрать, то (например): при переборе Борис остается в вездеходе к концу цикла.
                ...
                // в строчку 50 - удалось ли сесть в транспорт (вместо просто вызова метода строка 48).
